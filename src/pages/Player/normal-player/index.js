      ...
      <NormalPlayerContainer ref={normalPlayerRef}>
        ...
        <Top className="top">
          <div className="back" onClick={() => toggleFullScreenDispatch(false)}>
            <IconFont type="iconxiala" className="iconfont icon-back" style={{ cursor: 'pointer' }}/>
          </div>
          <div className="text">
        ...
        <Bottom className="bottom">
          ...
          <Operators>
            <div className="icon i-left" onClick={changeMode}>
              <IconFont className="iconfont" type={getPlayMode()} style={{ cursor: 'pointer' }}/>
            </div>
            <div className="icon i-left" onClick={handlePrev}>
            <IconFont type="iconshangyishou" className="iconfont" style={{ cursor: 'pointer' }}/>
            </div>
            <div className="icon i-center">
              <IconFont className="iconfont" onClick={clickPlayingCB} type={playing ? "iconzanting1" : "iconbofang21"} style={{ cursor: 'pointer' }}/>
            </div>
            <div className="icon i-right" onClick={handleNext}>
            <IconFont type="iconshangyishou1" className="iconfont" style={{ cursor: 'pointer' }}/>
            </div>
            <div
              className="icon i-right"
              onClick={() => togglePlayListDispatch(true)}
            >
              <IconFont type="iconbofangliebiao1" className="iconfont" style={{ cursor: 'pointer' }}/>
            </div>
          </Operators>
        </Bottom>
      </NormalPlayerContainer>
